			...
			<div class="table-responsive">
				<div class="table-wrapper">
					...
					<div class="table-title">
						<div class="row">
							<div class="col-sm-6">
								<h2 class="text-white font-weight-bold"><b>Manage Collection</b></h2>
							</div>
							<div class="col-sm-6">
								<a href="#add" class="btn btn-success" data-toggle="modal"><i class="material-icons">&#xE147;</i> <span>Add collection</span></a>					
							</div>
						</div>
					</div>
					<table class="table table-striped table-hover">
						<thead>
							<tr>
								<th>ID</th><th>Name</th><th>Discount</th><th>image</th><th>Action</th>
						...
						<tbody>
							<c:forEach items="${sessionScope.allcollections}" var="collection">
								<tr>
									...
									<td><img src="${collection.collectionimg}" alt="" style="height: 100px;width: 100%;object-fit: fill;"></td>
									<td>${collection.collectionimg}</td>
									<td>
										<a href="managecollection?id=${collection.collectionid}&delete=yes"><i class="material-icons">&#xE872;</i></a>
									</td>
								</tr>
							</c:forEach>
						</tbody>
