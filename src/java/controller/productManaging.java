 ...
 * @author TM080522
 */
public class productManaging extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if (ses.getAttribute("allproducts") == null || ses.getAttribute("allcategories") == null) {
			List<product> allproductlist = dao.getallProduct();
			ses.setAttribute("allproducts", allproductlist);
		}
		...
		if (searchString != null) {
			...
			if (searchlist.isEmpty()) {
				request.setAttribute("alert", "no product was found!");
			}
		} else {
